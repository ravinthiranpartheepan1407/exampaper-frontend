...
const ExamMarket = () => {
  ...
  const initialProducts = [
    ...
    { id: 2, name: 'JEE Main Mock Exam - Vol.1', image: 'https://fdryfwxmkllviwqmynme.supabase.co/storage/v1/object/public/exampaper/9.png', tags: ['JEE Main', "Math", "Physics", "Chemistry"], price: 'Company Calculator', link: '/mock-exams/jee-main-vol-1' },
    { id: 3, name: 'UPSC Preliminary Vol.1', image: 'https://fdryfwxmkllviwqmynme.supabase.co/storage/v1/object/public/exampaper/11.png', tags: ['UPSC', "History", "Geography", "Economy", "International Relations"], price: 'Company Calculator', link: '/mock-exams/upsc-preliminary-vol-1' },
    ...
    { id: 4, name: 'IC 11 - Practice of General Insurance', image: 'https://fdryfwxmkllviwqmynme.supabase.co/storage/v1/object/public/exampaper/12.png', tags: ['Licentiate', "III", "IRDAI", "General Insurance"], price: 'Company Calculator', link: '/mock-exams/ic-11' },
