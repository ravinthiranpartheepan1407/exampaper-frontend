...
export default function KnowblePsychologyOfSelling() {
  ...
  const [pdfUrl, setPdfUrl] = useState('https://zdmueezfheensjrefapy.supabase.co/storage/v1/object/sign/rust-timers/DSML.pdf?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJydXN0LXRpbWVycy9EU01MLnBkZiIsImlhdCI6MTc0MzgyODAwMywiZXhwIjozMzIwNjI4MDAzfQ.mUbQRGSX00QapOo9FLlhbn8XqD8Gsxhd6V3zFi23KP0');
