...
export default function KnowblePsychologyOfSelling() {
  ...
  const [pdfUrl, setPdfUrl] = useState('https://zdmueezfheensjrefapy.supabase.co/storage/v1/object/sign/rust-timers/Marketing.pdf?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJydXN0LXRpbWVycy9NYXJrZXRpbmcucGRmIiwiaWF0IjoxNzQzODI5MzA1LCJleHAiOjMzMjA2MjkzMDV9.mZA_JwCEzx9sCN6VGq3sA3RPk0Eq2GUXFEH75JFQ37k');
