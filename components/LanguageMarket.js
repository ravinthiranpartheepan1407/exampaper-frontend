...
import { Airplay, Disc, Filter, Focus, Layers, Notebook, NotebookText, Rocket, Search, Send, StepForward, X, Zap } from 'lucide-react';
import { useRouter } from 'next/navigation';

const LanguageMarket = () => {
  // Sample insurance products data
  const initialProducts = [
    { id: 1, name: 'Penny Park Adventure', image: 'https://zdmueezfheensjrefapy.supabase.co/storage/v1/object/sign/rust-timers/1.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InN0b3JhZ2UtdXJsLXNpZ25pbmcta2V5XzQxN2Q4ZTU4LTNkN2QtNDA2YS04YzM0LWViNzc3ZWIyYjM1MyJ9.eyJ1cmwiOiJydXN0LXRpbWVycy8xLnBuZyIsImlhdCI6MTc0NzM3OTgyNCwiZXhwIjozMzI0MTc5ODI0fQ.r1HYz7EtrqvhtEysYVrJAhb3sx0WD1bwDfsBVk0UH9I', tags: ["Kindergarden", "en", "School"], price: 'Company Calculator', link: '/language/en/penny-park-adventure' },
    { id: 2, name: 'Escape the Echo Labyrinth', image: 'https://fiqghoqztrzyahzlvmhb.supabase.co/storage/v1/object/public/language//7.png', tags: ["Elementary School", "en", "School"], price: 'Company Calculator', link: '/language/en/escape-the-echo-labyrinth' },
    { id: 3, name: 'Tara and Time Travelling Turtle', image: 'https://fiqghoqztrzyahzlvmhb.supabase.co/storage/v1/object/public/language//5.png', tags: ["Elementary School", "en", "School"], price: 'Company Calculator', link: '/language/en/tara-and-time-travelling-turtle' },
    { id: 4, name: 'The Cipher Quest', image: 'https://fiqghoqztrzyahzlvmhb.supabase.co/storage/v1/object/public/language//3.png', tags: ["Elementary School", "en", "School"], price: 'Company Calculator', link: '/language/en/cipher-quest' },
    { id: 5, name: 'Echoes of the Future', image: 'https://fiqghoqztrzyahzlvmhb.supabase.co/storage/v1/object/public/language//4.png', tags: ["High School", "en", "School"], price: 'Company Calculator', link: '/language/en/echoes-of-the-future' },
    { id: 6, name: 'The Paradox Protocol', image: 'https://fiqghoqztrzyahzlvmhb.supabase.co/storage/v1/object/public/language//6.png', tags: ["Employer", "en", "Business"], price: 'Company Calculator', link: '/language/en/the-paradox-protocol' },

    // { id: 2, name: 'NEET Vol.1 - Biology | Chemistry | Physics', image: 'https://zdmueezfheensjrefapy.supabase.co/storage/v1/object/sign/rust-timers/NEET-1.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InN0b3JhZ2UtdXJsLXNpZ25pbmcta2V5X2RlNzVhZmFiLWVkZTEtNGY1MC04YzdiLWY0YmYwNjQ5NmJlZiJ9.eyJ1cmwiOiJydXN0LXRpbWVycy9ORUVULTEucG5nIiwiaWF0IjoxNzQ0NTI5NTgwLCJleHAiOjMzMjEzMjk1ODB9.TmBkQoWjwSEGDwrIAsfY0gnhsYpulO-hAetsv32ozGQ', tags: ["Kindergarden", "en", "School"], price: 'Company Calculator', link: '/mindtrack' },
    ...
    <div style={{backgroundColor: 'white'}} className={styles.container}>
      <div className="hero-section">
          <div className="hero-content">
              <h1 style={{color: '#0097b2'}} className="hs-title-8">From Hello to Fluent</h1>
              <p style={{color: '#0097b2'}} className='hs-title'>Learn English with short stories you can read every day.</p>
