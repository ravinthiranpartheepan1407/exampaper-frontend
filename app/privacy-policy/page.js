...
export default function page() {
  return (
                        ...
                        <div className="text-center">
                          <div className="row">
                            <div className="col-md-8 offset-md-2">
                              <h2 style={{color: 'white'}}  className="section-caption-border mb-30 mb-xs-20 wow fadeInUp" data-wow-duration="1.2s">
                                Privacy Policy
                              </h2>
                              <h1 style={{color: 'white'}}  className="hs-title-1 mb-0">
                                <span className="wow charsAnimIn" data-splitting="chars">
                                  <AnimatedText text="Our Privacy Policy" />
                                  <p></p>
                                </span>
                              </h1>
                            </div>
    ...
    <div className="container wow fadeInUp">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Evalentum Private Limited, Global.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Evalentum, accessible from <a href="https://www.evalentum.com/" rel="external nofollow noopener" target="_blank">https://www.evalentum.com/</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: info@evalentum.com</li>
        </ul>
        </div>
        </div>
        </div>
